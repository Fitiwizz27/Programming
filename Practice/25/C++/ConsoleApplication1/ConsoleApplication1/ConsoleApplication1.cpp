...
bool check(vector<int> a, bool b)
{
	if (b == true)
	{
...
vector<int> BozoSort(vector<int> a, bool plus = true)
{
...
vector<int> BozoSort(vector<vector<int>> a, bool plus = true)
{
	vector<int> vec;
...
vector<int> BozoSort(int a, int b, int c, bool plus = true)
{
